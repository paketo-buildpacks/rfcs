...
- The candidate version must have a minor or patch version greater than zero. This ensures a one-month gap between the active LTS transition and the default Node.js version bump.
