...
As evidence of that, I have intentionally not updated any of the Node.js tools for these buildpacks for close to half a year and no one has reach out about it or complained about them being out of date. Including the companies that create these tools.
